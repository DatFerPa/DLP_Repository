...
public class ASTTest {
	...
	private static NodoAST crearArbol() {
		...
		// * Segunda Línea
		Sentencia sentencia = new Asignacion(2, 3, new Variable(2, 1, "a"),
				new Aritmetica(2, 11,
						new Aritmetica(2, 8, new MenosUnario(2, 6, new Variable(2, 7, "b")), "+",
								new LiteralEntero(2, 9, 3)),
						"*", new Aritmetica(2, 13, new Variable(2, 12, "c"), "/", new LiteralEntero(2, 14, 2))));
		...
		expresion = new Aritmetica(3, 10, new Variable(3, 9, "c"), "*", new LiteralEntero(3, 11, 2));
